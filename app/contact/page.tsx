...
export default function ContactPage() {
  ...
  return (
    <div className="bg-apple-bg min-h-screen pt-32 pb-20 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <FadeIn duration={0.8} delay={0.2} className="flex flex-col relative z-10 w-full max-w-lg items-center justify-center">
        <motion.div 
          layout
          className={`backdrop-blur-3xl shadow-[0_16px_64px_-12px_rgba(0,0,0,0.3)] dark:shadow-[0_16px_64px_-12px_rgba(255,255,255,0.02)] border border-black/5 dark:border-white/5 flex flex-col relative transition-transform duration-500 hover:scale-[1.01] overflow-hidden ${isSuccess ? 'bg-[#34C759] rounded-3xl w-64 h-64 text-white items-center justify-center' : 'bg-apple-card/95 rounded-3xl w-full'}`}
        >
