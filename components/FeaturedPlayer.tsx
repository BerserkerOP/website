...
export default function FeaturedPlayer(){
 const host=useRef<HTMLDivElement>(null),panel=useRef<HTMLDivElement>(null),player=useRef<Player>(),returnFocus=useRef<HTMLElement|null>(null);
 ...
 return <section className="spotlight-grid" aria-label="Motion Reel 2026 spotlight">
  {expanded&&<div className="featured-backdrop" onClick={collapse} aria-hidden="true"/>}
  <div className="wrap spotlight-frame">
   <header className="spotlight-heading"><span className="eyebrow">IN THE SPOTLIGHT</span><span className="mono">FEATURED FILM / 2026</span></header>
   <div className="spotlight-layout">
    <div className="spotlight-copy"><span className="mono">01 / MOTION REEL</span><h2>Made to<br/>move.</h2><p>A compact look at recent product stories, kinetic type, and commercial motion.</p></div>
