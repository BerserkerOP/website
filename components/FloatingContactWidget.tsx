    ...
    <>
      ...
      <div className="fixed bottom-5 left-1/2 -translate-x-1/2 z-50">
        <motion.div
          ...
          className="relative flex items-center rounded-full overflow-hidden cursor-pointer select-none border border-white/80 dark:border-white/15 bg-white/70 dark:bg-zinc-900/80 backdrop-blur-2xl shadow-xl transition-all duration-300 p-1"
        >
          {/* Specular Highlight */}
          ...
          {/* Left Text Label: "Get in touch" — Fades out & collapses on hover */}
          ...
          {/* Black Contact Button — Expands to fill the glassy container on hover */}
          <motion.div
            layout
