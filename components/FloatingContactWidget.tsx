    ...
    <>
      ...
      <div className="fixed bottom-5 left-1/2 -translate-x-1/2 z-50">
        ...
        >
          ...
          {/* Left Text Label: "Get in touch" — Collapses & fades out on hover */}
          ...
          {/* Black Contact Button — Takes over the whole glassy container on hover */}
          <motion.button
            layout
            whileTap={{ scale: 0.95 }}
            className="relative flex items-center justify-center gap-2 rounded-full z-10 overflow-hidden select-none"
            style={{
              padding: hovered ? '10px 24px' : '9px 14px',
