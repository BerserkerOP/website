  ...
  return (
    <div className="relative [perspective:1000px] w-full sm:w-auto group">
      ...
      >
        ...
        <span className={`relative z-10 flex items-center gap-2 transition-colors duration-150 ${glow ? 'group-hover:bg-apple-blue group-hover:text-white group-active:bg-apple-blue group-active:text-white w-full h-full bg-apple-bg rounded-[inherit] justify-center' : ''} ${innerClassName}`}>
          {children}
        </span>
